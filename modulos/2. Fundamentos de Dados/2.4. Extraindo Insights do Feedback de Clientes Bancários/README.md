...
Nesta atividade, são seguidas algumas etapas simples que, ao final, irão ajudar a extrair insights de feedbacks de clientes bancários com apoio de IA, usando contexto, critérios de análise e cuidados com dados sensíveis.

## 💡 Sobre o Exercício
Um bom prompt nasce de intenção clara, contexto e instruções específicas. O desafio tem com proposta de organizar ideias e transformá-las em comandos claros.

## 🧩 Construção Passo a Passo
Cada etapa adiciona uma nova peça ao seu prompt final. Tendo como objetivo de ao final ter um prompt capaz de orientar uma IA a produzir o que foi imaginado inicialmente.

## 🚀 Como Resolver
Seguindo cada passo, registrando as respostas e, ao final, a união de todos os elementos para formar o prompt final. 

---

## 🛠️ Tecnologias e Ferramentas Utilizadas
* **Inteligência Artificial:** Modelos de Linguagem (LLMs) para processamento de texto.
* **Markdown:** Para documentação e estruturação deste guia.
...
4. Copie o link e cole no campo de submissão da plataforma DIO.
...
5. Cole o link no campo de submissão da plataforma DIO.

> 💡 **Dica:** O formato `.md` no GitHub já é renderizado de forma visual e organizada automaticamente, sem precisar de nenhuma configuração extra!

---

### 4. Formato de Saída (Output)
* Determine como os insights devem ser entregues (ex: tabela, tópicos, relatório resumido).

## 📄 Estrutura do Prompt Final
Após responder e passar por todas as etapas acima, consolide a estrutura do seu comando no bloco abaixo:

```text
[Cole aqui o seu prompt final estruturado]
```

## 📬 Como Contribuir / Entregar o Desafio
1. Faça um **Fork** deste repositório.
2. Crie uma **Branch** para sua resolução (`git checkout -b minha-solucao`).
3. Responda às etapas diretamente neste arquivo ou crie um arquivo `PROMPT.md`.
4. Commit suas alterações (`git commit -m 'Desafio concluído'`).
5. Envie para o repositório remoto (`git push origin minha-solucao`).
6. Abra um **Pull Request** para avaliação.
